...
Pod::Spec.new do |s|
  s.name             = 'PBPasscode'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PBPasscode.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Jie Nim/PBPasscode'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jie Nim' => 'jie@getpocketbook.com' }
  s.source           = { :git => 'https://github.com/Jie Nim/PBPasscode.git', :tag => s.version.to_s }
